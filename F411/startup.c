...
const void DMA1_Channel0_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
const void ADC_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
const void DMA2_Channel6_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
const void DMA2_Channel7_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
const void USART6_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
const void OTG_FS_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
const void TIM5_IRQHandler(void) __attribute__((weak, alias("Default_Handler")));
...
const uint32_t isr_vector[] __attribute__((section(".isr_vector"), used)) = {
    ...
    (const uint32_t) &DMA1_Channel0_IRQHandler,
    ...
    (const uint32_t) &ADC_IRQHandler,
    0,
    0,
    0,
    0,
    (const uint32_t) &EXTI9_5_IRQHandler,
    (const uint32_t) &TIM1_BRK_TIM9_IRQHandler,
    (const uint32_t) &TIM1_UP_TIM10_IRQHandler,
    (const uint32_t) &TIM1_TRG_COM_TIM11_IRQHandler,
    ...
    (const uint32_t) &EXTI17_RTC_Alarm_IRQHandler,
    (const uint32_t) &EXIT18_OTG_FS_WKUP_IRQHandler,
    0,
    0,
    0,
    0,
    ...
    0,
    (const uint32_t) &SDIO_IRQHandler,
    (const uint32_t) &TIM5_IRQHandler,
    (const uint32_t) &SPI3_IRQHandler,
    0,
    0,
    0,
    0,
    (const uint32_t) &DMA2_Channel0_IRQHandler,
    (const uint32_t) &DMA2_Channel1_IRQHandler,
    (const uint32_t) &DMA2_Channel2_IRQHandler,
    (const uint32_t) &DMA2_Channel3_IRQHandler,
    (const uint32_t) &DMA2_Channel4_IRQHandler,
    0,
    0,
    0,
    0,
    0,
    0,
    (const uint32_t) &OTG_FS_IRQHandler,
    (const uint32_t) &DMA2_Channel5_IRQHandler,
    (const uint32_t) &DMA2_Channel6_IRQHandler,
    (const uint32_t) &DMA2_Channel7_IRQHandler,
    (const uint32_t) &USART6_IRQHandler,
    (const uint32_t) &I2C3_EV_IRQHandler,
    (const uint32_t) &I2C3_ER_IRQHandler,
    0,
    0,
    0,
    0,
    ...
    0,
    0,
    (const uint32_t) &FPU_IRQHandler,
    0,
    0,
    (const uint32_t) &SPI4_IRQHandler,
    (const uint32_t) &SPI5_IRQHandler,
};
